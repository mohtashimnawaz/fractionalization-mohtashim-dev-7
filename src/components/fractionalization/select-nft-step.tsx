          ...
          >
            <div className="p-4 space-y-3">
              <div className="relative aspect-square w-full overflow-hidden rounded-lg bg-muted">
                <Image
                  src={nft.image && String(nft.image).trim() !== '' ? String(nft.image) : '/placeholder-nft.png'}
                  alt={nft.name && String(nft.name).trim() !== '' ? String(nft.name) : `cNFT ${nft.mint ?? nft.id ?? index}`}
                  fill
